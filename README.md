...
## 📌 研究目標
本專案針對企業在 Visual Studio 環境中導入 GitHub Copilot 的安全性、合規性及授權管理進行深入研究，並提供具體的資安檢查清單與技術實作。

## 🛡️ 資安與合規文件
- [資安合規檢查清單 (Checklist)](./README.md)
- [保險業資安自律規範合規研究 (Regulatory Compliance)](./taiwan_regulatory_compliance.md)
- [保險業導入合規注意事項 (Detailed Checklist)](./compliance_checklist_detailed.md)
- [PII 數據防護深度研究報告 (PII Deep Dive)](./pii_protection_deep_dive.md)
- [Visual Studio 攔截代理實作指南 (PII Interceptor)](./pii_interceptor_guide.md)
...
- `scripts/audit_log_backup.py`: GitHub Audit Logs 增量備份腳本。

---
*本專案內容持續更新中，旨在提供保險業導入 AI 輔助開發的最佳實踐藍圖。*
